...
const ELEMENTS = {
    ...
    text2: {content: `<div contenteditable><p>sbuda</p><div>`,
            icon: '<i class="bi bi-fonts">2</i>'},
    image: {content: '<img src="https://picsum.photos/100"/>',
            icon: '<i class="bi bi-image"></i>'},
    video: {content: `<video controls width="250">
    ...
    button: {
        content: `<button>Button</button>`, icon: `<button>button</button>`
    },
    inputText: {
        content: `<input type="text" placeholder="text here">`, icon: '<i class="bi bi-fonts">form input</i>'
    },
    inputNumber: {
        content: `<input type="number" placeholder="0">`, icon: '<i class="bi bi-123">form input</i>'
    }
}